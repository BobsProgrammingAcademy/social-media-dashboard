...
This responsive social media dashboard is built using **HTML 5**, **CSS 3**, and **JavaScript**.
...
![plot](https://github.com/BobsProgrammingAcademy/social-media-dashboard/blob/master/images/vscode.png?raw=true)
